      ...
      preview: (
        <div className="w-full h-full flex flex-col items-center justify-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="px-3 py-1 rounded bg-electric-blue text-white text-xs font-bold ring-4 ring-electric-blue/20">
              1.5x
            </div>
        ...
        <div className="space-y-4">
          {features.map((f, idx) => (
            <div
              ...
              className={`flex gap-6 p-6 rounded-2xl cursor-pointer transition-all duration-300 border ${
                activeFeature === idx
            ...
            >
              <div className="shrink-0">
                <div
                  className={`flex items-center justify-center h-14 w-14 rounded-xl ${f.color} text-2xl shadow-inner`}
                >
                  {f.icon}
                </div>
              </div>
              <div>
                <h3
                  className={`text-xl font-bold mb-2 ${activeFeature === idx ? 'text-white' : 'text-white/80'}`}
                >
                  {f.title}
                </h3>
