...
export default function ControlBar({
  ...
  const canScrub = canControl && playbackMode === 'stream';

  return (
    <>
      {showFallbackToast && (
        <div className="toast toast-top toast-center z-100 mt-4">
          <div className="glass rounded-2xl border border-amber-500/30 bg-amber-500/10 px-5 py-3 shadow-[0_18px_60px_rgba(0,0,0,0.32)] backdrop-blur-xl flex items-center gap-3 text-sm text-white animate-bounce">
