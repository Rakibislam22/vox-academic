        ...
        <div className="sticky top-0 z-40 w-full border-b border-white/10 bg-[rgba(5,11,24,0.72)] px-4 py-3 backdrop-blur-xl lg:hidden">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex-1 text-center">
              <span className="text-subheading font-semibold tracking-[0.18em] accent-primary">
                Vox
              </span>
            </div>
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  ...
                  <span className="text-left min-w-0">
                    <span className="block max-w-24 truncate text-xs font-medium leading-4 sm:max-w-28">
                      {displayName}
                    </span>
                    <span className="block max-w-24 truncate text-[10px] text-white/60 sm:max-w-28">
                      {provider}
                    </span>
                  </span>
                </button>
                ...
                <ul
                  tabIndex={0}
                  className="menu dropdown-content mt-3 w-60 rounded-box border border-white/10 bg-base-100 p-2 shadow-xl"
                >
