        ...
        {[
          {
            icon: '🎙️',
            title: 'Natural Voice',
            desc: 'Choose from multiple voices with authentic pronunciation',
          },
          {
            icon: '⚡',
            title: 'Lightning Fast',
            desc: 'Convert PDFs to audio in seconds, not hours',
          },
          {
            icon: '🧠',
          ...
          <div
            key={idx}
            className="group relative panel p-6 hover:border-light/60 transition-all duration-300 cursor-pointer hover:shadow-[0_0_20px_rgba(26,140,255,0.2)]"
          >
