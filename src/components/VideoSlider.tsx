            ...
            {activeVideoList.map((video, index) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-b from-transparent to-gradient-bg pointer-events-none" style={{
                            backgroundImage: 'linear-gradient(to bottom, transparent, #050b18)'
                        }} />
                    </div>
                );
            })}
