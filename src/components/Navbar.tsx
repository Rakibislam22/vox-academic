        ...
        <div className="navbar-end gap-3">
          {!isAuthenticated ? (
            <>
              <Link
                href="/login"
                className="btn btn-ghost hidden sm:inline-flex text-white/85 hover:bg-white/5 hover:text-white"
              >
                Login
              </Link>
              <Link
                href="/signup"
                className="btn btn-primary border-0 bg-linear-to-r from-cyan-500 to-sky-500 text-white hover:from-cyan-400 hover:to-sky-400"
              >
                Sign up
              </Link>
            </>
            ...
            <div className="dropdown dropdown-end">
              <button
                tabIndex={0}
                className="btn btn-ghost border border-white/10 bg-white/5 text-white hover:bg-white/10"
              >
              ...
              <ul
                tabIndex={0}
                className="menu dropdown-content mt-3 w-56 rounded-box border border-white/10 bg-base-100 p-2 shadow-xl"
              >
