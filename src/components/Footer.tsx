            ...
            <div className="flex gap-3">
              {['Twitter', 'LinkedIn', 'GitHub'].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-lg bg-electric-blue/10 hover:bg-electric-blue/20 transition-all flex items-center justify-center text-xs text-electric-blue hover:text-cyan-accent"
                >
                  {social[0]}
                </a>
              ))}
        ...
        <div className="border-t border-blue-600/40 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 text-sm text-white/50">
              <span>
                Status: <span className="text-green-400">Development</span>
              </span>
            </div>
          </div>
        </div>
